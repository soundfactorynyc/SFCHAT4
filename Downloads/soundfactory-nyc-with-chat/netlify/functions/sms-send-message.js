...
// POST { to, body }
// Secured via API key header: x-api-key must match process.env.SMS_API_KEY when set.
...
exports.handler = async (event) => {
  ...
  // API key auth (optional). If SMS_API_KEY is defined, require a match BEFORE parsing heavy body.
